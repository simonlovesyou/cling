module.exports = {
  ...
  rules: {
    ...
    "unicorn/no-null": ["error"], // Disallow the use of the `null` literal. [(`unicorn/no-null`)](https://github.com/sindresorhus/eslint-plugin-unicorn/blob/main/docs/rules/no-null.md)
    ...
    "@typescript-eslint/no-non-null-assertion": ["error"], // Disallows non-null assertions using the ! postfix operator   [(`@typescript-eslint/no-non-null-assertion`)](https://github.com/typescript-eslint/typescript-eslint/blob/master/packages/eslint-plugin/docs/rules/no-non-null-assertion.md)
